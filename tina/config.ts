...
const payloadSectionBlockFields = [
  {
    type: "string",
    name: "type",
    label: "Type"
...
const contentFields = {
  ...
  description:
    "Editable source payload used by the website renderer. Very complex nested arrays are preserved but not fully exposed until their templates are normalized.",
  fields: [
    {
      type: "string",
      name: "format",
